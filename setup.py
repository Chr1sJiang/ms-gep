...
__author__ = "Chris Jiang"
__email__ = "jty.private@foxmail.com"
__copyright__ = "Copyright 2022 Chris Jiang"
__license__ = "None"
__version__ = "0.1"

projectName = "ms-gep"
shortDescription = "ms-gep for Python"
longDescription = """
TODO
"""
...
setup(
    ...
    cmdclass=cmdclass,
    packages=find_packages(), install_requires=['matplotlib']
)
